<?php 
    ...
    */
    class Database
    {
        ...
        {
            $this->link = mysqli_connect("localhost","root","","webtreeshow") or die ();
        ...
        public function filterProduct($table , $ten)
        {
            $sql = "SELECT * FROM {$table} ORDER BY {$ten} ASC ";
            $result = mysqli_query($this->link,$sql) or die("Lỗi  truy vấn filterProduct " .mysqli_error($this->link));
        ...
        public  function fetchJones($table,$sql,$total = 1,$page = 0,$row ,$pagi = true )
        {
            ...
            if ($pagi == true )
            {
                //Tổng số bản ghi chia cho số bản ghi cần hiển thị
