...
<head>
  ...
  <link href="<?php echo duongdan() ?>public/admin/css/style.css" rel="stylesheet">
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <a class="navbar-brand mr-1" href="<?php echo duongdan()?>index.php">Shopping Tree Admin</a>
  ...
  <div id="wrapper">
    ...
    <ul class="sidebar navbar-nav">
      <li class="nav-item">
        <a class="nav-link" href="<?php echo duongdan()?>admin/index.php">
